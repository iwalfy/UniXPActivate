...
/* https://stackoverflow.com/a/67672409/21404423 */
uint64_t __emulu(uint32_t a, uint32_t b) {
    return (uint64_t)a * b;
}
...
#define ERR_TOO_SHORT           XP_ACTIVATE_ERR_TOO_SHORT
#define ERR_TOO_LARGE           XP_ACTIVATE_ERR_TOO_LARGE
#define ERR_INVALID_CHARACTER   XP_ACTIVATE_ERR_INVALID_CHARACTER
#define ERR_INVALID_CHECK_DIGIT XP_ACTIVATE_ERR_INVALID_CHECK_DIGIT
#define ERR_UNKNOWN_VERSION     XP_ACTIVATE_ERR_UNKNOWN_VERSION
#define ERR_UNLUCKY             XP_ACTIVATE_ERR_UNLUCKY

#define CHARTYPE char
int xp_activate32_generate(const CHARTYPE* installation_id_str, CHARTYPE confirmation_id[49])
{
